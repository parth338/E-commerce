...
/** vendor page routes */
    ...
    Route::get('vendors', [HomeController::class, 'vendorPage'])->middleware('auth')->name('vendors');
    // Route::get('vendors', [PageController::class, 'vendorPage'])->name('vendors');
...
// For user profile and Dashboard
